...
var menu = [
    {
        name: '酒店',
        children: [
            {url: 'hotel/list', name: '列表'},
            {url: 'hotel/room/list', name: '房间'}
        ]
    },
    {name: '线路列表', url: 'line/list',},
    ...
    {name: '数据字典', url: 'dict/list'},
    {
        name: '线路',
        children: [
            {url: 'scenery/list', name: '列表'},
            {url: 'scenery/ticket/list', name: '门票'}
        ]
    },
    {name: '图片管理', url: 'img/list'},
    {
        name: '配置',
        children: [
            {url: 'config', name: '操作习惯'},
            {url: 'insurance/list', name: '保险列表'},
